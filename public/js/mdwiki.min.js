...
(function($) {
    ...
    function createPageContentMenu () {
        ...
        $('#md-content-row').append('<div class="col-md-3" id="md-right-column"/>');

        var recalc_width = function () {
            // if the page menu is affixed, it is not a child of the
            // <md-right-column> anymore and therefore does not inherit
            // its width. On every resize, change the class accordingly
            var width_left_column = $('#md-right-column').css('width');
